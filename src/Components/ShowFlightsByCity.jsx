...
// export default class ShowAllFlightsByCity extends React.Component {
...
//    showCity()
//    {
//        axios.get("http://localhost:5163/api/Customer/ShowFlightsByFromAndTo/"+this.state.fromcity+"/"+this.state.tocity).then(r=>
//        {      
//        console.log(r.data);
...
//         <>   
//          <form>
//                 <Select name="tocity" onChange={this.getdata}>
//                     {this.state.cities.map(x=>
//                         <MenuItem value={x.fromCity}>{x.fromCity}</MenuItem>
//                         )}
//                 </Select>
//                 <Select name="fromcity" onChange={this.getdata}>
//                     {this.state.cities.map(x=>
//                         <MenuItem value={x.fromCity}>{x.fromCity}</MenuItem>
//                         )}
//                 </Select>
//                 <div>
//                     <button type="button" onClick={this.showCity}>Show Flights</button>
//                 </div>
//           </form>      
//         <Paper sx={{ width: '100%' }}>
